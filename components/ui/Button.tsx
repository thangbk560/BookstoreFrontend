...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = "primary", size = "md", isLoading, children, disabled, ...props }, ref) => {
        ...
        const variants = {
            ...
            secondary: "bg-secondary hover:bg-secondary-600 text-dark-bg hover:shadow-lg",
            ghost: "bg-transparent hover:bg-light-border dark:hover:bg-dark-border text-light-text-primary dark:text-dark-text-primary",
